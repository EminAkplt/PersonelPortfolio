...
public static class DbSeeder
{
    public static async Task InitializeAsync(IServiceProvider services)
    {
        ...
        var defaults = new Dictionary<string, string>
        {
            ...
            [SiteContentKeys.ConsoleText] = string.Join('\n',
                "Ad         : Emin",
                "Rol        : Yazılım Mühendisi",
                "Konum      : Türkiye",
                "",
                "Yaptığım iş:",
                "  • İşletmelerin elle yürüttüğü süreçleri",
                "    sade web uygulamalarına dönüştürüyorum.",
                "  • .NET + PostgreSQL ağırlıklı; ölçülü ve",
                "    bakımı kolay sistemler kurarım.",
                "",
                "Şu an      : Arapça destekli bir yapay zekâ",
                "             uygulaması geliştiriyorum.",
                "",
                "# Detaylar için üstteki menüyü kullanın"),
            ...
            [$"{SiteContentKeys.ConsoleText}.en"] = string.Join('\n',
                "Name       : Emin",
                "Role       : Software Engineer",
                "Location   : Türkiye",
                "",
                "What I do  :",
                "  • I turn the manual processes businesses",
                "    run by hand into simple web apps.",
                "  • Mostly .NET + PostgreSQL; measured,",
                "    easy-to-maintain systems.",
                "",
                "Now        : Building an Arabic-enabled",
                "             AI application.",
                "",
